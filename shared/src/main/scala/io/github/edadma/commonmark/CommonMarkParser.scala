...
class CommonMarkParser {
  ...
  //
  //      while (!current_position.isAfterEnd && !current_position.element.closer) current_position =
  //        current_position.following
  //
  //      if (!current_position.isAfterEnd) {
  //        var opener = current_position.preceding
  //
  //        while (!opener.isBeforeStart && opener != stack_bottom && opener != openers_bottom(current_position.element.s) && !opener.element.opener) opener =
  //          opener.preceding
  //
